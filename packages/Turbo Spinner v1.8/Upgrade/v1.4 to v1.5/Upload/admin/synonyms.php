            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Add Synonyms</li>
                    </ol>
                </section>
                ...
                <section class="content">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Add Synonyms</h3>
                                </div><!-- /.box-header -->
                                <!-- form start -->
<?php
...
$db_data = file_get_contents('../core/'.$lang.'_db.sdata');
$add_synonyms = Trim(htmlspecialchars($_POST['synonyms']));
$db_data = "$db_data\n$add_synonyms";
file_put_contents('../core/'.$lang.'_db.sdata',$db_data);
      
       echo '
        <div class="alert alert-success alert-dismissable">
                                        <i class="fa fa-check"></i>
                                        <button aria-hidden="true" data-dismiss="alert" class="close" type="button">x</button>
                                        <b>Alert!</b> Synonyms added successfully
                                    </div>';
}
?> 
                                <form method="POST" action="synonyms.php">
                                    <div class="box-body">
                                    
                                    <div class="form-group">
                                            <label for="synonyms">Select Language Database:</label>
<select class="form-control" id="lang">
  ...
  <option value="in">Indonesian</option>
                                        ...
                                        <div class="form-group">
                                            <label for="synonyms">Enter a word and followed by synonyms</label>
                                            <div>Eg. reports|reviews|stories|studies|experiences</div>
                                            <input type="text" placeholder="Enter a word and synonyms here.." name="synonyms" id="synonyms" value="<?php echo $site_name; ?>" class="form-control">
                                        </div>
