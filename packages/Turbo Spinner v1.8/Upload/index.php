...
/*
* @author Balaji
* @name Turbo Spinner: Article Rewriter - PHP Script v1.8
...
$ban_user = 1;
  ...
  goto myoff;
    ...
    $query =  "SELECT color,mode,mul,allowed FROM capthca where id='0'";
...
function str_contains($haystack, $needle, $ignoreCase = false) {
    ...
    $query =  "SELECT title,des,keyword,site_name,email,twit,face,gplus,ga FROM site_info";
    $result = mysqli_query($con,$query);
    ...
    if (strpos($banned_ip,$ip) !== false)
    {
        ...
        $query =  "SELECT cap_e FROM capthca WHERE id=".Trim('0');
        $result = mysqli_query($con,$query);
