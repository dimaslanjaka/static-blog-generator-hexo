...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
	{	
		...
		if(htmlspecialchars(trim($_POST['subject'])) === '')
		{
			$contactErrors['subject'] = 'Your full name is required.';
		}
		else
		{
		...
		else if (!preg_match("^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,3})$^", htmlspecialchars(trim($_POST['email']))))
		{
		...
		if(htmlspecialchars(trim($_POST['message']) === ''))
		{
		...
		if (empty($contactErrors) && htmlspecialchars(trim($emailTo)) !== '')
		{			
			$body = "Name: $name \n\nEmail: $email \n\nMessage: $message";
...
<h2>
Contact Us
<small>Use the contact form below to get in touch with us</small>
...
<p class="text">Thank you, we have received your message and will reply as soon as possible.</p> <br>
';
}
else
{
echo '<br /> <hr> <h2>Error <span> - Try Again</span></h2> <br />
<b>Somthing went Wrong........</b> <br />';
}
}
?>
</h2>
...
<p>If you have any queries, comments, suggestions or have anything to talk about.</p>
</div>
<div style="text-align: center;" id="adx-area"> <br />
<?php echo $ads_2; ?>
</div>
<br />
</div>
...
<div class="form-group">
<textarea rows="10" class="form-control" name="message" placeholder="Place your message here..."></textarea>
</div>
<div class="form-group">
<input type="submit" class="buttonlink" name="Submit" value="Send Message" />
</div>
</form>
</div>
</div>
