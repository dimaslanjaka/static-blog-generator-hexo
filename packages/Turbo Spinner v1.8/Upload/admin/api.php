        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-bar-chart-o"></i> Admin</a></li>
                        <li class="active">API Access</li>
                    </ol>
                </section>
                ...
                <section class="content">
                                ...
                                <br />
                                <b>&nbsp;&nbsp;Generate new API key: &nbsp;</b>
                                <a href="create.php" class="btn btn-primary">Generate now</a>
                                    <br /> <br /> 
                        </div>
                                ...
                                <div class="box-body">
                                    <table class="table table-striped">
                                        <tbody><tr>
                                            <th>API Key</th>
                                            <th>Expiry date</th>
                                            <th>No. of request allowed</th>
                                            <th>Word limit/per request</th>
                                            <th>Remaining request</th>
                                            <th>Delete</th>
                                        </tr>
...
$query = "DELETE FROM api_access WHERE id=$delete";
$result = mysqli_query($con,$query);
...
$rec_limit = 10;   
$query = "SELECT count(id) FROM api_access";
...
$sql = "SELECT * FROM api_access ORDER BY `id` DESC LIMIT $offset, $rec_limit";
