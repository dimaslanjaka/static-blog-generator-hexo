...
(function(){
  ...
  var createEmbedFrame = function(){
    ...
    var uriOriginal           = "http://jsfiddle.net/dimaslanjaka/e0sjfjy6/embed/result"
    var uriOriginalNoProtocol = uriOriginal.split("//").pop()
    var uriEmbedded           = "http://jsfiddle.net/e0sjfjy6/embedded/result/?username=dimaslanjaka"
    var currentSlug           = "e0sjfjy6"
...
(function(){
  ...
  var createEmbedFrame = function(){
    var uid                   = "JSFEMB_" + (~~(new Date().getTime() / 86400000))
    var uriOriginal           = "http://jsfiddle.net/dimaslanjaka/e0sjfjy6/embed/css/dark"
    var uriOriginalNoProtocol = uriOriginal.split("//").pop()
    var uriEmbedded           = "http://jsfiddle.net/e0sjfjy6/embedded/css/dark/?username=dimaslanjaka"
    var currentSlug           = "e0sjfjy6"
    var target                = document.querySelector("script[src*='" + uriOriginalNoProtocol + "']")
    var iframe                = document.createElement("iframe")
...
(function(){
  ...
  var createEmbedFrame = function(){
    var uid                   = "JSFEMB_" + (~~(new Date().getTime() / 86400000))
    var uriOriginal           = "http://jsfiddle.net/dimaslanjaka/e0sjfjy6/embed/js/dark"
    var uriOriginalNoProtocol = uriOriginal.split("//").pop()
    var uriEmbedded           = "http://jsfiddle.net/e0sjfjy6/embedded/js/dark/?username=dimaslanjaka"
    var currentSlug           = "e0sjfjy6"
    var target                = document.querySelector("script[src*='" + uriOriginalNoProtocol + "']")
    var iframe                = document.createElement("iframe")
...
(function(){
  ...
  var createEmbedFrame = function(){
    var uid                   = "JSFEMB_" + (~~(new Date().getTime() / 86400000))
    var uriOriginal           = "http://jsfiddle.net/dimaslanjaka/e0sjfjy6/embed/html/dark"
    var uriOriginalNoProtocol = uriOriginal.split("//").pop()
    var uriEmbedded           = "http://jsfiddle.net/e0sjfjy6/embedded/html/dark/?username=dimaslanjaka"
    var currentSlug           = "e0sjfjy6"
    var target                = document.querySelector("script[src*='" + uriOriginalNoProtocol + "']")
    var iframe                = document.createElement("iframe")
