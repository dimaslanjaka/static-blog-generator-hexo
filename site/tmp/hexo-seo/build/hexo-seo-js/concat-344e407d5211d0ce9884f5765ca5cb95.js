...
(function(){
  ...
  var createEmbedFrame = function(){
    ...
    var uriOriginal           = "http://jsfiddle.net/cLmop5wc/embed/html"
    var uriOriginalNoProtocol = uriOriginal.split("//").pop()
    var uriEmbedded           = "http://jsfiddle.net/cLmop5wc/embedded/html/"
    var currentSlug           = "cLmop5wc"
...
(function(){
  ...
  var createEmbedFrame = function(){
    var uid                   = "JSFEMB_" + (~~(new Date().getTime() / 86400000))
    var uriOriginal           = "http://jsfiddle.net/96xk73x1/embed/js"
    var uriOriginalNoProtocol = uriOriginal.split("//").pop()
    var uriEmbedded           = "http://jsfiddle.net/96xk73x1/embedded/js/"
    var currentSlug           = "96xk73x1"
    var target                = document.querySelector("script[src*='" + uriOriginalNoProtocol + "']")
    var iframe                = document.createElement("iframe")
