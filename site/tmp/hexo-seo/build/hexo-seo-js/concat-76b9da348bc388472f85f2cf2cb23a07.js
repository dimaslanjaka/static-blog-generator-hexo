...
(function(){
  ...
  var createEmbedFrame = function(){
    ...
    var uriOriginal           = "http://jsfiddle.net/dimaslanjaka/c01de4w7/embed/result"
    var uriOriginalNoProtocol = uriOriginal.split("//").pop()
    var uriEmbedded           = "http://jsfiddle.net/c01de4w7/embedded/result/?username=dimaslanjaka"
    var currentSlug           = "c01de4w7"
...
var disqus_config = function () {this.page.url = 'https://www.webmanajemen.com/2017/09/simple-recent-posts-blogger-plus.html';this.page.identifier = 'dimaslanjaka';};
