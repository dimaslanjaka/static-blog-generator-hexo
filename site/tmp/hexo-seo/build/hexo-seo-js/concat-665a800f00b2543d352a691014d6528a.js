...
document.write('<form method="get" action="https://www.bestchange.com/index.php" target="_blank" style="margin: 0; padding: 0">\
  <table align="center" cellpadding="0" cellspacing="0" border="0" style="font: 12px Tahoma, Verdana, sans-serif; color: #ffffff; margin: 0 auto 0 auto">\
  <tr>\
    <td><select name="from" style="font: 12px Tahoma, Verdana, sans-serif; color: #4d5d39">\
<option value="93">Bitcoin (BTC)</option>\
<option value="131">Bitcoin LN (BTC)</option>\
<option value="43">Bitcoin BEP20 (BTCB)</option>\
<option value="73">Wrapped BTC (WBTC)</option>\
<option value="172">Bitcoin Cash (BCH)</option>\
<option value="137">Bitcoin SV (BSV)</option>\
<option value="184">Bitcoin Gold (BTG)</option>\
<option value="139">Ethereum (ETH)</option>\
<option value="212">Ethereum BEP20 (ETH)</option>\
<option value="218">Wrapped ETH (WETH)</option>\
<option value="160">Ether Classic (ETC)</option>\
<option value="99">Litecoin (LTC)</option>\
<option value="161">Ripple (XRP)</option>\
<option value="149">Monero (XMR)</option>\
<option value="115">Dogecoin (DOGE)</option>\
<option value="138">Polygon (MATIC)</option>\
<option value="140">Dash (DASH)</option>\
<option value="162">Zcash (ZEC)</option>\
<option value="163">Tether Omni (USDT)</option>\
<option value="36">Tether ERC20 (USDT)</option>\
<option value="10" selected="selected">Tether TRC20 (USDT)</option>\
<option value="208">Tether BEP20 (USDT)</option>\
<option value="180">Tether SOL (USDT)</option>\
<option value="23">USDCoin ERC20 (USDC)</option>\
<option value="110">USDCoin TRC20 (USDC)</option>\
<option value="235">USDCoin BEP20 (USDC)</option>\
<option value="228">USDCoin SOL (USDC)</option>\
<option value="24">TrueUSD (TUSD)</option>\
<option value="189">Pax Dollar (USDP)</option>\
<option value="203">Dai (DAI)</option>\
<option value="206">Binance USD (BUSD)</option>\
<option value="173">NEM (XEM)</option>\
<option value="177">NEO (NEO)</option>\
<option value="178">EOS (EOS)</option>\
<option value="179">IOTA (MIOTA)</option>\
<option value="181">Cardano (ADA)</option>\
<option value="182">Stellar (XLM)</option>\
<option value="185">TRON (TRX)</option>\
<option value="133">Waves (WAVES)</option>\
<option value="48">OMG Network (OMG)</option>\
<option value="124">Verge (XVG)</option>\
<option value="168">0x (ZRX)</option>\
<option value="16">BinanceCoin BEP2 (BNB)</option>\
<option value="19">BinanceCoin BEP20 (BNB)</option>\
<option value="104">ICON (ICX)</option>\
<option value="134">Komodo (KMD)</option>\
<option value="27">BitTorrent (BTT)</option>\
<option value="61">BAT (BAT)</option>\
<option value="135">Ontology (ONT)</option>\
<option value="26">Qtum (QTUM)</option>\
<option value="197">Chainlink (LINK)</option>\
<option value="198">Cosmos (ATOM)</option>\
<option value="175">Tezos (XTZ)</option>\
<option value="201">Polkadot (DOT)</option>\
<option value="202">Uniswap (UNI)</option>\
<option value="205">Ravencoin (RVN)</option>\
<option value="82">Solana (SOL)</option>\
<option value="8">VeChain (VET)</option>\
<option value="210">Shiba ERC20 (SHIB)</option>\
<option value="32">Shiba BEP20 (SHIB)</option>\
<option value="216">Algorand (ALGO)</option>\
<option value="213">Maker (MKR)</option>\
<option value="217">Avalanche (AVAX)</option>\
<option value="220">Yearn.finance (YFI)</option>\
<option value="227">Decentraland (MANA)</option>\
<option value="2">Terra (LUNA)</option>\
<option value="76">NEAR Protocol (NEAR)</option>\
<option value="144">Cronos (CRO)</option>\
<option value="209">Toncoin (TON)</option>\
<option value="40">Perfect Money USD</option>\
<option value="41">Perfect Money EUR</option>\
<option value="128">Perfect Money BTC</option>\
<option value="156">PM e-Voucher USD</option>\
<option value="45">PayPal USD</option>\
<option value="80">PayPal EUR</option>\
<option value="164">PayPal GBP</option>\
<option value="98">PayPal RUB</option>\
<option value="88">Advanced Cash USD</option>\
<option value="120">Advanced Cash EUR</option>\
<option value="121">Advanced Cash RUB</option>\
<option value="142">Advanced Cash UAH</option>\
<option value="33">Advanced Cash KZT</option>\
<option value="20">Advanced Cash TRY</option>\
<option value="44">Skrill USD</option>\
<option value="123">Skrill EUR</option>\
<option value="1">WebMoney WMZ</option>\
<option value="3">WebMoney WME</option>\
<option value="96">WebMoney WMX</option>\
<option value="87">Paymer USD</option>\
<option value="108">Payeer USD</option>\
<option value="122">Payeer EUR</option>\
<option value="117">Payeer RUB</option>\
<option value="74">Paxum USD</option>\
<option value="72">Neteller USD</option>\
<option value="136">Neteller EUR</option>\
<option value="152">PaySera USD</option>\
<option value="35">PaySera EUR</option>\
<option value="200">ecoPayz USD</option>\
<option value="154">Epay USD</option>\
<option value="97">Epay EUR</option>\
<option value="165">Alipay CNY</option>\
<option value="241">WeChat CNY</option>\
<option value="145">Capitalist USD</option>\
<option value="226">Capitalist EUR</option>\
<option value="85">Capitalist RUB</option>\
<option value="109">NixMoney USD</option>\
<option value="125">NixMoney EUR</option>\
<option value="112">Global24 UAH</option>\
<option value="6">YooMoney RUB</option>\
<option value="63">QIWI RUB</option>\
<option value="127">QIWI KZT</option>\
<option value="103">Payoneer USD</option>\
<option value="11">Idram AMD</option>\
<option value="49">Mobile Wallet RUB</option>\
<option value="12">Mobile Wallet UAH</option>\
<option value="148">Cryptoexchange USD</option>\
<option value="153">Cryptoexchange EUR</option>\
<option value="129">Exmo USD</option>\
<option value="186">Exmo BTC</option>\
<option value="130">Exmo RUB</option>\
<option value="169">Exmo UAH</option>\
<option value="50">Exmo USDT</option>\
<option value="126">Binance RUB</option>\
<option value="255">Binance Code RUB</option>\
<option value="190">Cryptex USD</option>\
<option value="28">Kuna UAH</option>\
<option value="214">WhiteBIT USD</option>\
<option value="58">Visa/MasterCard USD</option>\
<option value="65">Visa/MasterCard EUR</option>\
<option value="146">Visa/MasterCard GBP</option>\
<option value="30">Visa/MasterCard CNY</option>\
<option value="155">Visa/MasterCard SEK</option>\
<option value="38">Visa/MasterCard PLN</option>\
<option value="194">Visa/MasterCard MDL</option>\
<option value="83">Visa/MasterCard TRY</option>\
<option value="59">Visa/MasterCard RUB</option>\
<option value="60">Visa/MasterCard UAH</option>\
<option value="54">Visa/MasterCard BYN</option>\
<option value="111">Visa/MasterCard KZT</option>\
<option value="5">Visa/MasterCard AMD</option>\
<option value="25">Visa/MasterCard KGS</option>\
<option value="221">Visa/MasterCard CAD</option>\
<option value="222">Visa/MasterCard BGN</option>\
<option value="223">Visa/MasterCard HUF</option>\
<option value="224">Visa/MasterCard CZK</option>\
<option value="225">Visa/MasterCard NOK</option>\
<option value="237">Visa/MasterCard AZN</option>\
<option value="238">Visa/MasterCard GEL</option>\
<option value="239">Visa/MasterCard UZS</option>\
<option value="240">Visa/MasterCard TJS</option>\
<option value="100">UnionPay Card CNY</option>\
<option value="17">Mir Card RUB</option>\
<option value="9">UZCARD Card UZS</option>\
<option value="199">HUMO Card UZS</option>\
<option value="69">Bank transfer USD</option>\
<option value="70">Bank transfer EUR</option>\
<option value="81">Bank transfer GBP</option>\
<option value="71">Bank transfer RUB</option>\
<option value="102">Bank transfer UAH</option>\
<option value="31">Bank transfer BYN</option>\
<option value="113">Bank transfer KZT</option>\
<option value="219">Bank transfer GEL</option>\
<option value="166">Bank transfer CNY</option>\
<option value="39">Bank transfer TRY</option>\
<option value="29">Bank transfer PLN</option>\
<option value="167">Bank transfer THB</option>\
<option value="119">Bank transfer INR</option>\
<option value="188">Bank transfer NGN</option>\
<option value="183">Bank transfer IDR</option>\
<option value="7">Bank transfer BGN</option>\
<option value="196">Bank transfer AED</option>\
<option value="232">Bank transfer JPY</option>\
<option value="231">Bank transfer AUD</option>\
<option value="233">Bank transfer CAD</option>\
<option value="234">Bank transfer HKD</option>\
<option value="248">Bank transfer VND</option>\
<option value="249">Bank transfer MYR</option>\
<option value="250">Bank transfer NZD</option>\
<option value="251">Bank transfer PKR</option>\
<option value="171">Sepa EUR</option>\
<option value="192">Revolut USD</option>\
<option value="193">Revolut EUR</option>\
<option value="174">Wise USD</option>\
<option value="242">Wise EUR</option>\
<option value="187">ERIP Raschet BYN</option>\
<option value="42">Sberbank RUB</option>\
<option value="229">Sberbank QR RUB</option>\
<option value="51">VTB RUB</option>\
<option value="52">Alfa-Bank RUB</option>\
<option value="143">Alfa cash-in USD</option>\
<option value="62">Alfa cash-in RUB</option>\
<option value="64">Russian Standard RUB</option>\
<option value="79">Avangard RUB</option>\
<option value="47">Tinkoff USD</option>\
<option value="105">Tinkoff RUB</option>\
<option value="46">Tinkoff cash-in RUB</option>\
<option value="147">Tinkoff QR RUB</option>\
<option value="53">Promsvyazbank RUB</option>\
<option value="95">Gazprombank RUB</option>\
<option value="57">Kukuruza RUB</option>\
<option value="157">Raiffeisen RUB</option>\
<option value="132">RNCB RUB</option>\
<option value="176">Openbank RUB</option>\
<option value="170">Post Bank RUB</option>\
<option value="34">RSHB RUB</option>\
<option value="195">Rosbank RUB</option>\
<option value="191">MTS Bank RUB</option>\
<option value="215">Home Credit RUB</option>\
<option value="55">Privat 24 USD</option>\
<option value="56">Privat 24 UAH</option>\
<option value="158">Raiffeisen UAH</option>\
<option value="68">Oschadbank UAH</option>\
<option value="22">UkrSibbank UAH</option>\
<option value="118">PUMB UAH</option>\
<option value="84">Monobank UAH</option>\
<option value="37">Alfa-Bank UAH</option>\
<option value="4">Belarusbank BYN</option>\
<option value="90">HalykBank KZT</option>\
<option value="114">Sberbank KZT</option>\
<option value="75">ForteBank KZT</option>\
<option value="66">Kaspi Bank KZT</option>\
<option value="207">Jusan Bank KZT</option>\
<option value="21">SBP RUB</option>\
<option value="159">SP or LLC bank RUB</option>\
<option value="252">Bank transfer ILS</option>\
<option value="67">WU USD</option>\
<option value="15">WU EUR</option>\
<option value="78">MoneyGram USD</option>\
<option value="77">MoneyGram EUR</option>\
<option value="150">Ria USD</option>\
<option value="151">Ria EUR</option>\
<option value="101">Contact USD</option>\
<option value="86">UNI USD</option>\
<option value="14">UNI RUB</option>\
<option value="106">Contact RUB</option>\
<option value="116">GC USD</option>\
<option value="107">GC RUB</option>\
<option value="89">Cash USD</option>\
<option value="141">Cash EUR</option>\
<option value="204">Cash GBP</option>\
<option value="211">Cash AED</option>\
<option value="91">Cash RUB</option>\
<option value="18">Cash TRY</option>\
<option value="92">Cash UAH</option>\
<option value="13">Cash BYN</option>\
<option value="94">Cash KZT</option>\
<option value="230">Cash COP</option>\
<option value="236">Cash PLN</option>\
<option value="243">Cash ILS</option>\
<option value="244">Cash CZK</option>\
<option value="245">Cash GEL</option>\
<option value="246">Cash AMD</option>\
<option value="247">Cash CAD</option>\
<option value="253">Cash THB</option>\
<option value="254">Cash AUD</option>\
</select></td>\
    <td style="color: #ffffff">&nbsp;to&nbsp;</td>\
    <td><select name="to" style="font: 12px Tahoma, Verdana, sans-serif; color: #4d5d39">\
<option value="93">Bitcoin (BTC)</option>\
<option value="131">Bitcoin LN (BTC)</option>\
<option value="43">Bitcoin BEP20 (BTCB)</option>\
<option value="73">Wrapped BTC (WBTC)</option>\
...
<option value="163">Tether Omni (USDT)</option>\
<option value="36">Tether ERC20 (USDT)</option>\
<option value="10">Tether TRC20 (USDT)</option>\
<option value="208">Tether BEP20 (USDT)</option>\
<option value="180">Tether SOL (USDT)</option>\
<option value="23">USDCoin ERC20 (USDC)</option>\
<option value="110">USDCoin TRC20 (USDC)</option>\
...
<option value="144">Cronos (CRO)</option>\
<option value="209">Toncoin (TON)</option>\
<option value="40" selected="selected">Perfect Money USD</option>\
<option value="41">Perfect Money EUR</option>\
<option value="128">Perfect Money BTC</option>\
<option value="156">PM e-Voucher USD</option>\
<option value="45">PayPal USD</option>\
...
<option value="254">Cash AUD</option>\
    ...
    <td><input type="submit" value="Find the best rate" style="font: 12px Tahoma, Verdana, sans-serif; color: #4d5d39" /></td>\
  </tr>\
  </table>\
  <input type="hidden" name="p" value="410410" />\
</form>');
