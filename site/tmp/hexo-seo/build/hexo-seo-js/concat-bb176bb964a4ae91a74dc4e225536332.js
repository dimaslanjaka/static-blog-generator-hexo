...
(function(){
  ...
  var createEmbedFrame = function(){
    ...
    var uriOriginal           = "http://jsfiddle.net/dimaslanjaka/1s0pa5zz/embed/html,css,result/dark"
    var uriOriginalNoProtocol = uriOriginal.split("//").pop()
    var uriEmbedded           = "http://jsfiddle.net/1s0pa5zz/embedded/html,css,result/dark/?username=dimaslanjaka"
    var currentSlug           = "1s0pa5zz"
...
var disqus_config = function () {this.page.url = 'https://www.webmanajemen.com/2018/02/create-external-link-icons-using-svg.html';this.page.identifier = 'dimaslanjaka';};
