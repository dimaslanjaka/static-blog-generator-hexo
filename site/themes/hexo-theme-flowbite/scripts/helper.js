...
function getKeywords(page) {
    ...
    if (page.tags) {
        if (typeof page.tags.each === "function") {
            ...
            results.push.apply(results, page.tags);
        }
    }
    if (page.categories) {
        if (typeof page.categories.each === "function") {
            ...
            results.push.apply(results, page.categories);
        }
    }
    return results;
}
...
hexo.extend.helper.register("list_related_posts", function (post, options, hexoInstance) {
